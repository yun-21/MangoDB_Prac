        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, collection.insertOne({ name: 'Alice', age: 30 })];
                case 2:
                    _a.sent();
                ...
                case 4:
                    ...
                    return [4 /*yield*/, collection.updateOne({ name: 'Alice' }, { $set: { age: 31 } })];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, collection.deleteOne({ name: 'Bob' })];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 9];
